...
from MishuChatbot import OWNER, MishuChatbot
...
DEV_OP = [
    [
        InlineKeyboardButton(
            ...
            url=f"https://t.me/{MishuChatbot.username}?startgroup=true",
        ),
    ],
    [
...
ABOUT_BTN = [
    [
        InlineKeyboardButton(text="❍ 𝐒ᴜᴘᴘᴏʀᴛ ❍", url=f"https://t.me/ChatOnMasti"),
        InlineKeyboardButton(text="❍ 𝐇ᴇʟᴘ ❍", callback_data="HELP"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="❍ 𝐔ᴘᴅᴀᴛᴇ ❍", url=f"https://t.me/About_Zain"),
        InlineKeyboardButton(text="❍ 𝐁ᴀᴄᴋ ❍", callback_data="BACK"),
    ],
]
