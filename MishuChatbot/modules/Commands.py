...
from MishuChatbot.database.chats import add_served_chat
from MishuChatbot.database.users import add_served_user
from config import MONGO_URL, OWNER_ID
from MishuChatbot import MishuChatbot, mongo, LOGGER, db
from MishuChatbot.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@MishuChatbot.on_message(filters.command(["lang", "language", "setlang"]))
...
@MishuChatbot.on_message(filters.command("status"))
...
@MishuChatbot.on_message(filters.command(["resetlang", "nolang"]))
...
@MishuChatbot.on_message(filters.command("chatbot"))
