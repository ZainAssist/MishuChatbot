...
from MishuChatbot import CLONE_OWNERS
from MishuChatbot import MishuChatbot as app, save_clonebot_owner, save_idclonebot_owner
from MishuChatbot import MishuChatbot, db as mongodb
    ...
    if len(message.command) > 1:
        ...
        try:
            ai = Client(
                ...
                no_updates=False,
                plugins=dict(root="MishuChatbot.idchatbot"),
            )
            await ai.start()
