...
from MishuChatbot.idchatbot.helpers import is_owner
from MishuChatbot import mongo
...
import time
import io
from MishuChatbot import CLONE_OWNERS, db, MishuChatbot
...
from MishuChatbot.database.clonestats import get_served_cchats, get_served_cusers, add_served_cuser, add_served_cchat
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup, Message, CallbackQuery
from MishuChatbot.idchatbot.helpers import (
    START,
    START_BOT,
    PNG_BTN,
    CLOSE_BTN,
...
AUTO = True
ADD_INTERVAL = 200
users = "MishuChatbot"  # don't change because it is connected from client to use chatbot API key
async def add_bot_to_chats():
    try:
        
        bot = await MishuChatbot.get_users(users)
        bot_id = bot.id
